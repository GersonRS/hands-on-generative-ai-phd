...
server_agent = Agent(model=model, system_prompt="always reply in rhyme")


@server.tool()
async def search_qdrant(theme: str) -> str:
    """Poem generator"""
...
if __name__ == "__main__":
    # server.run(transport="sse") # legacy
    server.run(transport="streamable-http")  # atual
